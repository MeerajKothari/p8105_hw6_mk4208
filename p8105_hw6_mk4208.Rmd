...
Both the distributions apprear normally distributed. The mean of r² is `r results %>% pull(r.squared) %>% mean` and the median of r² is `r results %>% pull(r.squared) %>% median`.
